...
import com.ziwenl.library.fresco.zoomable.gestures.TransformGestureDetector;
...
public class DefaultZoomableController implements ZoomableController, TransformGestureDetector.Listener {
    ...
    /**
     * add ziwen 调整最大放大倍数由 2.0f 调整为 3.0f (与 PhotoView 默认放大倍数一致)
     */
